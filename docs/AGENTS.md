...
| -------------------- | ------------------------------------ | ----- | -------------------------------- | -------------------------------------- |
| **Test Plan Writer** | `pm-draft-test-plan.agent.md`        | haiku | KB artifact (test-plan)          | Drafts runnable test plans             |
| **UI/UX Advisor**    | `pm-uiux-recommendations.agent.md`   | haiku | KB artifact (uiux-notes)         | Provides UI/UX compliance guidance     |
| **Dev Feasibility**  | `pm-dev-feasibility-review.agent.md` | haiku | KB artifact (pm_dev_feasibility) | Reviews scope for feasibility and risk |
