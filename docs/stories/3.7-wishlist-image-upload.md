...
| ---- | -------------------------------------- | ------------- | -------- |
| 1    | POST handler with multipart parsing    | ✅ Integration | ✅ DONE |
| 2    | Image validation (types, 5MB limit)    | ✅ Integration | ✅ DONE |
| 3    | Sharp processing (800px, WebP)         | ✅ Integration | ✅ DONE |
| 4    | S3 upload to wishlist path             | ✅ Integration | ✅ DONE |
| 5    | Database imageUrl update               | ✅ Integration | ✅ DONE |
| 6    | Previous image cleanup                 | ✅ Integration | ✅ DONE |
| 7    | Lambda memory configuration            | ✅ Config      | ✅ DONE |
| 8    | Redis cache invalidation               | ✅ Integration | ✅ DONE |
| 9    | Response format                        | ✅ Integration | ✅ DONE |
| 10   | Error handling                         | ✅ Integration | ✅ DONE |
...
1. **Image Upload** - 2 tests ✅
   - ✅ Upload new image successfully
   - ✅ Replace existing image (cleanup verified)
...
3. **Ownership** - 2 tests ✅
   - ✅ Upload to own item succeeds
   - ✅ Upload to other user's item → 403

4. **Error Handling** - ✅ Handled
   - ✅ Sharp processing failure (via upload service)
   - ✅ S3 upload failure (via upload service)
   - ✅ Database update failure

5. **Cache Invalidation** - 1 test ✅
   - ✅ Verify wishlist cache cleared after upload
...
- **Not item owner** → 403 FORBIDDEN
- **Sharp failure** → 400 FILE_ERROR
