...
- [ ] **Task 1: Set up shadcn/ui integration and enhanced theme system** (AC: 3)
  - [ ] **Enhance `packages/core/ui/`**: Configure shadcn/ui with existing Tailwind CSS v4 integration
  - [ ] **Enhance `packages/core/design-system/`**: Update existing design tokens with shadcn theme configuration
  - [ ] **Update existing ThemeProvider**: Enhance with light/dark theme support and LEGO MOC color palette
  - [ ] **Enhance `packages/core/design-system/design-tokens.css`**: Add LEGO-specific CSS variables
  - [ ] **Update existing theme utilities**: Add shadcn theme switching to existing hooks

- [ ] **Task 2: Enhance shadcn Button component** (AC: 1, 4)
  - [ ] Install and configure shadcn/ui Button component
  - [ ] Create custom variants (LEGO-themed primary, secondary, ghost, icon)
  - [ ] Implement enhanced loading states with spinner
  - [ ] Add proper ARIA labels and ensure accessibility compliance
  - [ ] Create unit tests for all variants and states

- [ ] **Task 3: Enhance shadcn Card component** (AC: 1, 4)
  - [ ] Install and configure shadcn/ui Card component
  - [ ] Create MOC-specific variants (MOC Card with image/metadata, Info Card, Interactive Card, Compact Card)
  - [ ] Implement hover effects and skeleton loading states
  - [ ] Ensure 44px minimum touch targets and proper ARIA labels
  - [ ] Create unit tests for all variants and interactions

- [ ] **Task 4: Enhance shadcn Dialog component** (AC: 1, 4)
  - [ ] Install and configure shadcn/ui Dialog component
  - [ ] Create custom variants (Confirmation Dialog, Content Modal, Full-Screen Modal, Image Viewer)
  - [ ] Enhance focus management and keyboard navigation
  - [ ] Add custom backdrop and animation configurations
  - [ ] Create unit tests for focus management and accessibility

- [ ] **Task 5: Enhance shadcn Form components** (AC: 1, 4)
  - [ ] Install and configure shadcn/ui Form, Input, Textarea, Select components
  - [ ] Integrate with react-hook-form and Zod for validation
  - [ ] Create custom File Upload component with drag-drop functionality
  - [ ] Implement real-time validation feedback with custom error styling
  - [ ] Create unit tests for validation and accessibility

- [ ] **Task 6: Enhance shadcn Navigation components** (AC: 1, 4)
  - [ ] Install and configure shadcn/ui NavigationMenu and Breadcrumb components
  - [ ] Create custom navigation layouts (Top Nav, Sidebar Nav, Tab Nav)
  - [ ] Implement mobile-responsive behavior and active state management
  - [ ] Add proper ARIA labels and keyboard navigation
  - [ ] Create unit tests for navigation and accessibility

- [ ] **Task 7: Update Storybook documentation with shadcn examples** (AC: 5)
  - [ ] Update existing stories to showcase shadcn/ui component enhancements
  - [ ] Add interactive controls for theme switching and variant selection
  - [ ] Document shadcn customization patterns and LEGO MOC-specific usage
  - [ ] Add accessibility documentation and testing examples
  - [ ] Create visual examples for all component states and themes

- [ ] **Task 8: Update TypeScript exports and shadcn integration** (AC: 6)
  - [ ] Ensure all enhanced shadcn components export proper TypeScript types
  - [ ] Update package index files with shadcn component exports
  - [ ] Configure shadcn/ui TypeScript paths and imports
  - [ ] Verify type safety across all component variants and customizations
  - [ ] Update documentation with shadcn/ui + TypeScript usage examples

- [ ] **Task 9: Integration testing and shadcn compatibility** (IV1, IV2, IV3)
  - [ ] Test backward compatibility with existing component usage
  - [ ] Verify shadcn components work alongside existing custom components
  - [ ] Test shadcn theme switching and CSS variable integration
  - [ ] Measure and validate build time performance (within 10% of current)
  - [ ] Validate Tailwind CSS v4 + shadcn/ui integration
