...
| ---- | -------------------------------------- | ------------- | -------- |
| 1    | Lambda at parse-parts-list.ts          | TBD           | ⏳ PENDING |
| 2    | S3 upload then Lambda invocation       | TBD           | ⏳ PENDING |
| 3    | CSV parsing with csv-parser            | TBD           | ⏳ PENDING |
| 4    | Expected CSV format validated          | TBD           | ⏳ PENDING |
| 5    | Validation (valid CSV, max 10k rows)   | TBD           | ⏳ PENDING |
| 6    | Data stored in mocPartsLists table     | TBD           | ⏳ PENDING |
| 7    | totalPieceCount aggregated and updated | TBD           | ⏳ PENDING |
| 8    | Lambda timeout 5 minutes               | TBD           | ⏳ PENDING |
| 9    | Lambda memory 512 MB                   | TBD           | ⏳ PENDING |
| 10   | Response format                        | TBD           | ⏳ PENDING |
