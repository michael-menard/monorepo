...
| **PM: Test Plan**     | pm-draft-test-plan           | KB artifact (test-plan)                  |
| **PM: Feasibility**   | pm-dev-feasibility           | KB artifact (pm_dev_feasibility)         |
| **PM: UI/UX**         | pm-uiux-recommendations      | KB artifact (uiux-notes)                 |
