...
COMMENT ON COLUMN schema_migrations.filename IS 'Migration filename, e.g. 1130_cdts_safety_preamble.sql. Must be unique.';
...
VALUES ('1130_cdts_safety_preamble.sql', current_user)
