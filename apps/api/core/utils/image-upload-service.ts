...
// TODO: Implement these metrics using core/observability/metrics instead of @monorepo/lambda-utils
// const { recordUploadSuccess, recordUploadFailure, recordFileSize, recordImageDimensions, measureProcessingTime }
...
export async function uploadImage(
  ...
  try {
    ...
    // TODO: recordFileSize(file.buffer.length, uploadType)
    ...
    if (!validationResult.isValid) {
      // TODO: recordUploadFailure(uploadType, 'validation')
    ...
    // TODO: recordImageDimensions(processedImage.width, processedImage.height, uploadType)
    ...
    try {
      ...
      // TODO: recordUploadFailure(uploadType, 's3')
      throw error
    }
    ...
    // TODO: recordUploadSuccess(uploadType)
    ...
    if (error instanceof Error && !error.message.includes('Invalid file')) {
      // TODO: recordUploadFailure(uploadType, 'database')
    }
    throw error
  }
}
