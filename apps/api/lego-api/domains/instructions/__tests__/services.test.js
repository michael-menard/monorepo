...
import { createInstructionsService } from '../application/services.js';
/**
...
function createMockInstructionRepo() {
    return {
...
describe('InstructionsService', () => {
    ...
    describe('listMocs', () => {
        it('returns paginated MOCs for user', async () => {
            ...
            expect(instructionRepo.findByUserId).toHaveBeenCalledWith('user-123', { page: 1, limit: 20 }, undefined);
        });
        it('passes filters to repository', async () => {
            await service.listMocs('user-123', { page: 1, limit: 20 }, { type: 'moc', theme: 'Castle' });
            expect(instructionRepo.findByUserId).toHaveBeenCalledWith('user-123', { page: 1, limit: 20 }, { type: 'moc', theme: 'Castle' });
        });
    });
    describe('updateMoc', () => {
