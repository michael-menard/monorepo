 ...
 */
export function generateInstructionFileKey(userId, mocId, filename) {
 ...
 */
export function generateThumbnailKey(userId, mocId) {
    return `mocs/${userId}/${mocId}/thumbnail.webp`;
}
/**
 * Generate S3 key for a MOC gallery image
 */
export function generateGalleryImageKey(userId, mocId, imageId) {
    return `mocs/${userId}/${mocId}/gallery/${imageId}.webp`;
}
/**
 * Generate S3 key for a parts list file
 */
export function generatePartsListKey(userId, mocId, filename) {
