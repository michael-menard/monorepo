 ...
 */
export function createSetsService(deps) {
    ...
    return {
         ...
         */
        async getSetWithImages(userId, setId) {
         ...
         */
        async listSets(userId, pagination, filters) {
         ...
         */
        async uploadSetImage(userId, setId, file, input) {
         ...
         */
        async getSetImage(userId, imageId) {
         ...
         */
        async listSetImages(userId, setId) {
            // Check ownership
            const setResult = await this.getSet(userId, setId);
            if (!setResult.ok) {
                return setResult;
         ...
         */
        async updateSetImage(userId, imageId, input) {
         ...
         * Delete a set image
         */
        async deleteSetImage(userId, imageId) {
            // Get image and verify ownership
            const imageResult = await this.getSetImage(userId, imageId);
            if (!imageResult.ok) {
                return imageResult;
