...
import { CreateSetInputSchema, UpdateSetInputSchema, ListSetsQuerySchema, CreateSetImageInputSchema, UpdateSetImageInputSchema, } from './types.js';
// ─────────────────────────────────────────────────────────────────────────
...
sets.post('/:setId/images', async (c) => {
    ...
    const result = await setsService.uploadSetImage(userId, setId, {
        buffer,
        filename: file.name,
        mimetype: file.type,
        size: file.size,
