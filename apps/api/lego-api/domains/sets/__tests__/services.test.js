...
function createMockSetImageRepo() {
    return {
...
describe('SetsService', () => {
    ...
    describe('listSets', () => {
        it('returns paginated sets for user', async () => {
            ...
            expect(setRepo.findByUserId).toHaveBeenCalledWith('user-123', { page: 1, limit: 20 }, undefined);
        });
        it('passes filters to repository', async () => {
            await service.listSets('user-123', { page: 1, limit: 20 }, { theme: 'Star Wars', isBuilt: true });
            expect(setRepo.findByUserId).toHaveBeenCalledWith('user-123', { page: 1, limit: 20 }, { theme: 'Star Wars', isBuilt: true });
        });
    });
    describe('createSet', () => {
