 ...
 */
export const MIME_TYPE_ALIASES: Record<string, (typeof ALLOWED_MIME_TYPES)[number]> = {
...
export type SecurityLogEvent = z.infer<typeof SecurityLogEventSchema>
 ...
 */
export function validateFileSize(sizeBytes: number | undefined | null): ValidationResult {
