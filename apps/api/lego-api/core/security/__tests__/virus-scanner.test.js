...
import { createClamAVVirusScanner, createMockVirusScanner, createVirusScanner, ScanResultSchema, } from '../virus-scanner.js';
// Mock logger
vi.mock('@repo/logger', () => ({
    logger: {
        warn: vi.fn(),
...
describe('ClamAV Virus Scanner', () => {
    ...
    describe('scanFile', () => {
        ...
        it('should log scan initiation', async () => {
            ...
            expect(logger.info).toHaveBeenCalledWith('Virus scan initiated', expect.objectContaining({
        ...
        it('should log scan completion', async () => {
            ...
            expect(logger.info).toHaveBeenCalledWith('Virus scan completed', expect.objectContaining({
                status: 'clean',
                scanner: 'clamav',
            }));
        });
    ...
    describe('handleInfectedFile', () => {
        ...
        it('should log infected file detection', async () => {
            ...
            expect(logger.warn).toHaveBeenCalledWith('Infected file detected', expect.objectContaining({
