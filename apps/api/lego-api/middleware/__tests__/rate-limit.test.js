...
const { rateLimitStore, isRateLimited, recordFailure, getRetryAfterSeconds, cleanupExpiredEntries, getClientIp, MAX_FAILURES_PER_WINDOW, RATE_LIMIT_WINDOW_MS, } = __testing;
// Mock @repo/logger
vi.mock('@repo/logger', () => ({
    logger: {
        warn: vi.fn(),
