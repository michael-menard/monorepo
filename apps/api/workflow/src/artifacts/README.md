...
- **Zod Schema (Runtime Validation)**: `apps/api/workflow/src/artifacts/__types__/user-flows.ts`
- **Example Flow**: `apps/api/workflow/src/artifacts/__tests__/fixtures/example-user-flow.json`
...
```typescript
import { UserFlowsSchema, type UserFlows } from '@repo/workflow-svc/artifacts/__types__/user-flows'
...
```typescript
import { UserFlowsSchema } from '@repo/workflow-svc/artifacts/__types__/user-flows'
...
```bash
pnpm --filter @repo/workflow-svc test src/artifacts/__tests__/user-flows.test.ts
```
...
See `apps/api/workflow/src/artifacts/__tests__/fixtures/example-user-flow.json` for a complete example demonstrating:
