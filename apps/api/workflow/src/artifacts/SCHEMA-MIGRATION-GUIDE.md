...
| `phase: "foundation"` | _(removed)_    | Preserved via `.passthrough()`       |
...
| `prefix: "WKFL"`            | _(removed)_                    | Preserved via `.passthrough()`         |
...
| `blocks: [...]`       | _(removed)_         | Preserved via `.passthrough()`              |
...
| `scope.out: [...]` | _(removed)_             | Preserved via `.passthrough()` |
