...
import { testConnection } from '@/core/database/client'
import { testOpenSearchConnection } from '@/core/search/opensearch'
import { ServiceUnavailableError } from '@/core/utils/responses'
  ...
  async (event: any): Promise<APIGatewayProxyResult> => {
    ...
    const healthData: HealthCheckData = {
      ...
      services: {
        ...
        redis: 'connected', // Redis is optional, mark as connected for now
