/**
 * Story 3.1.10: Uploader Upload Types
 *
 ...
 */
export function createEmptyBatchState(): UploadBatchState {
  return {
    files: [],
    overallProgress: 0,
    queuedCount: 0,
 ...
 */
export function calculateBatchState(
 ...
 */
export function mapHttpErrorToUploadError(
  httpStatus: number,
  apiErrorCode?: string,
): UploadErrorCode {
 ...
 */
export function createFileItem(file: File, category: FileCategory): UploaderFileItem {
  return {
    id: createFileId(),
    category,
    name: file.name,
