...
import { RouteGuards, LegacyRoutePatterns, RouteMetadata } from '@/lib/route-guards'
...
const forgotPasswordRoute = createRoute({
  ...
  beforeLoad: RouteGuards.guestOnly,
  meta: () => [RouteMetadata.forgotPassword],
})

const forgotPasswordRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: '/forgot-password',
  component: () => import('./pages/ForgotPasswordPage').then(m => m.ForgotPasswordPage),
...
const galleryRoute = createRoute({
  ...
  path: '/gallery',
  component: () => {
    // Lazy load gallery module
    return import('./modules/GalleryModule').then(module => module.GalleryModule)
  },
  pendingComponent: LoadingPage,
  beforeLoad: ({ context }) => {
