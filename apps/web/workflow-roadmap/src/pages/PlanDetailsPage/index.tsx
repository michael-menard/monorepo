...
export function PlanDetailsPage() {
  ...
  const handleTitleChange = (newValue: string) => {
    ...
    titleDebounceRef.current = setTimeout(() => {
      startTransition(() => {
        updatePlan({ slug, input: { title: newValue } })
          ...
          {editingField === 'title' ? (
            ...
            <div className="flex items-center gap-2 group/title flex-1 min-w-0">
              ...
              <CustomButton
                ...
                className="h-6 w-6 text-slate-500 hover:text-cyan-400 opacity-0 group-hover/title:opacity-100 transition-opacity shrink-0"
                title="Edit title"
              >
