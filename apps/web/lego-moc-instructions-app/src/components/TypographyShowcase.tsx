      ...
      <div className="mb-8">
        ...
        <div className="space-y-4 max-w-3xl">
          <p className="text-lg font-medium text-foreground leading-relaxed">
            Large body text (18px) - Medium weight. Perfect for introductory paragraphs and
            important content that needs emphasis.
          </p>
          <p className="text-base font-normal text-foreground leading-relaxed">
            Regular body text (16px) - Normal weight. This is the standard text size for most
            content. It provides excellent readability while maintaining a comfortable reading
            experience across all devices.
          </p>
          <p className="text-sm font-normal text-muted-foreground leading-relaxed">
            Small body text (14px) - Used for secondary information, captions, and less prominent
            content. Notice how it uses the muted foreground color for hierarchy.
          </p>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-3">
          <p className="text-base">
            ...
            <a
              href="#"
              className="text-primary hover:text-accent underline decoration-2 underline-offset-4 font-medium transition-colors"
            >
              hover link
            </a>{' '}
          ...
          <p className="text-base">
            You can also have <span className="text-primary font-semibold">highlighted text</span>{' '}
            and <span className="text-muted-foreground italic">italic emphasis</span> within
            paragraphs.
          </p>
        </div>
      </div>
    ...
    surface: '#F6F0F0'
      ...
      <div className="mb-8">
        ...
        <p className="text-base text-muted-foreground mb-6">
          Your custom color system with semantic naming
        </p>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div
              ...
              style={{ backgroundColor: 'rgba(18, 153, 144, 0.1)' }}
            >
