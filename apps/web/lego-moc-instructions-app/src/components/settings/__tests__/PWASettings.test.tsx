...
describe('PWASettings', () => {
  ...
  it('renders app installation section', () => {
    ...
    expect(screen.getByText('Install this app on your device for a native app experience')).toBeInTheDocument()
  })
  ...
  it('shows installation not available when canInstall is false and not installed', () => {
    ...
    expect(screen.getByText('App installation is not available on this device or browser.')).toBeInTheDocument()
  })
  ...
  it('shows ready to install when canInstall is true', () => {
    ...
    expect(screen.getByText('Install this app on your device for faster access and a better experience.')).toBeInTheDocument()
  ...
  it('shows app installed when running in standalone mode', () => {
    ...
    expect(screen.getByText('The app is installed and running in standalone mode.')).toBeInTheDocument()
  })
  ...
  it('shows update section when needRefresh is true', () => {
    ...
    expect(screen.getByText('A new version with the latest features and improvements is ready.')).toBeInTheDocument()
  ...
  it('shows offline ready status when offlineReady is true', () => {
    ...
    expect(screen.getByText('The app has been cached and will work even when you\'re offline.')).toBeInTheDocument()
  })
  ...
  it('shows setting up offline support when offlineReady is false', () => {
    ...
    expect(screen.getByText('The app is being prepared for offline use. This will complete automatically.')).toBeInTheDocument()
  })
