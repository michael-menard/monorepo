...
vi.mock('../../Navigation', () => ({
  default: ({ className }: { className?: string }) => (
    <div data-testid="navigation-component" className={className}>
      <a href="/moc-gallery" data-testid="nav-browse-mocs">
        Browse MOCs
      </a>
      <a href="/wishlist" data-testid="nav-wishlist">
        Wishlist
      </a>
...
const renderLayout = (children?: React.ReactNode) => {
  return render(
    <BrowserRouter>
      <Layout>{children || <div data-testid="test-content">Test Content</div>}</Layout>
    </BrowserRouter>,
  )
}
