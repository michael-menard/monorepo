...
describe('InspirationGallery', () => {
  ...
  describe('Rendering', () => {
    it('should render the inspiration gallery page with header', () => {
      ...
      expect(
        screen.getByText('Discover amazing LEGO creations that will inspire your next build'),
      ).toBeInTheDocument()
    })
  ...
  describe('Loading State', () => {
    it('should show loading state when data is loading', () => {
      ...
      expect(screen.getByRole('button', { name: /share inspiration/i })).toHaveAttribute(
        'aria-disabled',
        'true',
      )
    })
  ...
  describe('Error State', () => {
    it('should show error state when there is an error', () => {
      ...
      expect(
        screen.getByText('There was an error loading the inspiration gallery.'),
      ).toBeInTheDocument()
  ...
  describe('Inspiration Item Interactions', () => {
    it('should display inspiration item details correctly', () => {
      ...
      expect(screen.getByText('Amazing Space Station')).toBeInTheDocument()
      expect(
        screen.getByText('A stunning space station design that will inspire your next build'),
      ).toBeInTheDocument()
    ...
    it('should handle inspiration item click', () => {
      ...
      const firstItem = screen
        .getByText('Amazing Space Station')
        .closest('[data-testid="inspiration-item"]')
