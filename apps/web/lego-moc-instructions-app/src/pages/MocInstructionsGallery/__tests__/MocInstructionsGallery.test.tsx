...
describe('MocInstructionsGallery', () => {
  ...
  describe('Rendering', () => {
    it('renders the gallery page with correct title and description', () => {
      ...
      expect(screen.getByText('Discover amazing LEGO MOC instructions created by the community')).toBeInTheDocument();
    });
  ...
  describe('Responsive Design', () => {
    ...
    it('has responsive search and filter layout', () => {
      ...
      const responsiveContainer = screen.getByTestId('search-input')
