              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-1 text-sm text-gray-600">
                    ...
                    <span>{mocInstructionsStats?.averageRating?.toFixed(1) || '0.0'} avg rating</span>
                  </div>
                  <div className="text-xs text-gray-500">
              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-1 text-sm text-gray-600">
                    ...
                    <span>Member since {userStats ? formatDate(userStats.memberSince) : '2024'}</span>
                  </div>
                  <div className="text-xs text-gray-500">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                <li>Wishlist: {wishlistItems.length} items (${wishlistStats?.totalValue?.toFixed(2) || '0.00'})</li>
