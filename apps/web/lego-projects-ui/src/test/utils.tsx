 ...
 */
export const createMockApiResponse = (data: unknown, overrides = {}) => ({
  status: 200,
  message: 'Success',
  data,
  meta: {
...
export const submitForm = async (
  ...
  const button = submitButton || document.querySelector('[type="submit"]') as HTMLButtonElement
  if (button) {
 ...
 */
export const mockApiSuccess = (data: unknown, status: number = 200) => {
 ...
 */
export const mockApiError = (error: string, status: number = 400) => {
  return vi.fn().mockResolvedValue({
    ok: false,
    status,
