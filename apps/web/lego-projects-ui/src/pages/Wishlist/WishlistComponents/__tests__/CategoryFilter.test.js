...
describe('CategoryFilter', () => {
    it('renders all predefined categories', () => {
        render(_jsx(CategoryFilter, { value: null, onChange: () => { } }));
    ...
    it('calls onChange when a predefined category is selected', () => {
        ...
        render(_jsx(CategoryFilter, { value: null, onChange: onChange }));
    ...
    it('calls onChange with null when All is selected', () => {
        const onChange = vi.fn();
        render(_jsx(CategoryFilter, { value: categories[0], onChange: onChange }));
