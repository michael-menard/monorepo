...
vi.mock('framer-motion', () => {
    ...
    return {
        __esModule: true,
        motion: {
            div: React.forwardRef((props, ref) => _jsx("div", { ref: ref, ...props })),
        },
...
describe('MocGalleryCard', () => {
    ...
    it('renders with all fields', () => {
        render(_jsx(MocGalleryCard, { data: baseData }));
    ...
    it('shows overlay with "No Instructions" on hover if instructionsAvailable is false', () => {
        render(_jsx(MocGalleryCard, { data: { ...baseData, instructionsAvailable: false } }));
        const card = screen.getByTestId('mock-gallery-card');
        fireEvent.mouseEnter(card);
    ...
    it('calls onClick when card is clicked', () => {
        ...
        render(_jsx(MocGalleryCard, { data: baseData, onClick: handleClick }));
        const card = screen.getByTestId('mock-gallery-card');
    ...
    it('is queryable by data-testid', () => {
        render(_jsx(MocGalleryCard, { data: baseData, "data-testid": "custom-id" }));
