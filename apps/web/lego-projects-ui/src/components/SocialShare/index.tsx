...
export const SocialShare = React.memo(function SocialShare({
  url = window.location.href,
  title = 'Check out this amazing Lego project!',
  description = 'Discover incredible Lego building instructions and inspiration.',
  ...
  const handleShare = useCallback(async (link: typeof shareLinks[0]) => {
