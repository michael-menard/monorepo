 ...
 * Story WISH-2006: Accessibility (keyboard navigation)
 */
 ...
 * - WISH-2006: Keyboard navigation support with roving tabindex
 */
export const SortableWishlistCard = forwardRef<HTMLDivElement, SortableWishlistCardProps>(
  function SortableWishlistCard(
    ...
    return (
      ...
      >
        ...
        <div className={cn(isDraggingEnabled && 'mr-10')}>
          <WishlistCard
            ref={ref}
            item={item}
            onClick={onClick}
