...
import type { ImageRepository, AlbumRepository, ImageStorage } from '../ports.js'
import type { GalleryImage, GalleryAlbum } from '../types.js'
...
describe('GalleryService', () => {
  ...
  let service: ReturnType<typeof createGalleryService>
  ...
  describe('listImages', () => {
    it('returns paginated images for user', async () => {
      ...
      expect(imageRepo.findByUserId).toHaveBeenCalledWith(
        'user-123',
        { page: 1, limit: 20 },
        undefined
      )
