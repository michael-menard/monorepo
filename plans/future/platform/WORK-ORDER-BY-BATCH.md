...
- 🔧 = Being Worked (claimed by a worker — see Worker column)
...
**Ground truth for status:** this file is the single source of truth for work ordering and status.
The `/next-work` skill reads this file as a work queue — keep it accurate.
...
| ☑ | # | Story ID | Title | Status | Worker | Notes |
|---|---|----------|-------|--------|--------|-------|
...
| ☑ | # | Story ID | Title | Status | Worker | Dependencies | Notes |
|---|---|----------|-------|--------|--------|--------------|-------|
...
| ☑ | # | Story ID | Title | Status | Worker | Blocks | Dependencies |
|---|---|----------|-------|--------|--------|--------|--------------|
...
| ☑ | # | Story ID | Title | Status | Worker | Dependencies | Blocks |
|---|---|----------|-------|--------|--------|--------------|--------|
...
| ☑ | # | Story ID | Title | Status | Worker | Dependencies | Priority |
|---|---|----------|-------|--------|--------|--------------|----------|
...
| ☑ | # | Story ID | Title | Status | Worker | Dependencies |
|---|---|----------|-------|--------|--------|--------------|
...
| ☑ | # | Story ID | Title | Status | Worker | Dependencies | Priority |
|---|---|----------|-------|--------|--------|--------------|----------|
| [ ] | 52 | WINT-1070 | Deprecate stories.index.md | 🚧 | | WINT-1030 (#38) | P2 — implementation complete, needs code review |
| [ ] | 53 | WINT-1040 | Update story-status to Use DB | ⏳ |  | WINT-1011 (#48a), WINT-1030 (#38) | P2 — UAT verified |
| [ ] | 54 | WINT-1050 | Update story-update to Use DB | ⏳ |  | WINT-1011 (#48a), WINT-1030 (#38) | P2 — UAT verified |
| [ ] | 55 | WINT-1060 | Update story-move to Use DB | 🔧 | qa-verify | WINT-1011 (#48a), WINT-1030 (#38) | P2 — ready-for-qa |
| [ ] | 56 | KBAR-0050 | CLI Sync Commands | 🔧 | main | KBAR-0040 (#49) | P2 — implementation in progress |
...
| ☑ | # | Story ID | Title | Status | Worker | Dependencies | Notes |
|---|---|----------|-------|--------|--------|--------------|-------|
| [x] | 57 | WINT-9010 | Create Shared Business Logic Package ⚡ 🎯 | ✅ | | WINT-1100 (#35b) | UAT verified |
...
| [ ] | 59 | WINT-1160 | Add Parallel Work Conflict Prevention | 🔧 | pm-story | WINT-1130 (#44), WINT-1140 (#50) | P2 — **ready to start** |
...
| ☑ | # | Story ID | Title | Status | Worker | Dependencies | Priority |
|---|---|----------|-------|--------|--------|--------------|----------|
| [ ] | 64 | WINT-9020 | Create doc-sync LangGraph Node ⚡ | ⏳ | | WINT-9010 (#57), WINT-0160 (#21) | P0 — **ready to start** |
...
**Last updated: 2026-02-18 — reconciled against actual story directories**
...
- ⏳ Ready to Start: 3 stories (KBAR-0050, WINT-1040, WINT-1050)
- ⏸️ Blocked: remaining stories (waiting on dependencies)

**Active Stories: 50 tracked**

**Critical Path Tracking:**
- [x] LNGG-0010 ✅ → Batch 2 unblocked
- [x] WINT-0010 ✅ → Batch 3 schemas progressing
- [x] WINT-1100 ✅ → WINT-9010 unblocked
- [x] WINT-9010 ✅ → **ALL LangGraph nodes unblocked** (Batches 10-13)
- [ ] WINT-9110 ⏸️ → LangGraph operational! 🎉

**Next Actions (ordered by impact):**
1. **Code-review WINT-1060** → needs-code-review, unblocks Batch 8 completion
2. **Complete KBAR-0050** → in-progress, unblocks KBAR-0060 (#58)
3. **Complete WINT-1070** → being worked, unblocks downstream
4. **Start WINT-1160** (Conflict Prevention) — WINT-1130+1140 ✅
5. **Start WINT-9020** (doc-sync LangGraph Node) — WINT-9010 ✅, WINT-0160 ✅
6. **Start WINT-4080, WINT-4090** (scope-defender, evidence-judge) — no deps
7. **Start WINT-7020** (Agent Migration Plan) — WINT-7010 ✅
8. **Start MODL-0040, AUDT-0020** — deps satisfied
...
- When a story is claimed: update status to `🔧` + set Worker column to worktree name
...
- The `/next-work` skill reads this file top-to-bottom as a work queue — row order = priority order
