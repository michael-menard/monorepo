...
| APIP-5003 | LangGraph Platform Security Hardening and Network Boundary Documentation | APIP-0030 | Ready to Work |
...
| ID | Title | Dependencies | Status |
|---|---|---|---|
| APIP-1010 | Structurer Node in Elaboration Graph | APIP-0020 | Ready to Work |
| APIP-1020 | ChangeSpec Schema Design and Validation Spike | APIP-1010 | Ready to Work |
| APIP-1030 | Implementation Graph with Atomic Change Loop | APIP-1020, APIP-0040 | Needs Split |
| APIP-1040 | Documentation Graph (Post-Merge) | APIP-1030 | Ready to Work |
| APIP-1050 | Review Graph with Parallel Fan-Out Workers | APIP-1030 | Ready to Work |
...
| APIP-5002 | E2E Test Plan and Playwright Framework Setup | APIP-0010, APIP-0020, APIP-1010, APIP-1020, APIP-1030, APIP-1050, APIP-1060, APIP-1070 | Created |
...
| ID | Title | Dependencies | Status |
|---|---|---|---|
| APIP-2010 | Blocked Queue and Notification System | APIP-0020 | Created |
| APIP-2020 | Monitor UI v1 (Read-Only Dashboard) | APIP-2010 | Created |
| APIP-2030 | Graceful Shutdown, Health Check, and Deployment Hardening | APIP-0030 | Created |
