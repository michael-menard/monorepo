...
|-------|------|---------------|-------|-------------|-----------|--------|
| 0 | Foundation | 11 | 3 | 0 | 0 | backlog |
| 1 | Full Worker Graphs | 9 | 0 | 0 | 0 | backlog |
...
Minimal autonomous loop: Work queue, supervisor graph, LangGraph deployment, model router, and supporting infrastructure (test framework, test database, secrets engine, server provisioning, schema versioning).

| ID | Title | Dependencies | Status |
|---|---|---|---|
| APIP-0010 | BullMQ Work Queue Setup | none | Ready to Work |
| APIP-0020 | Supervisor Graph (Minimal Loop) | APIP-0010 | In Elaboration |
| APIP-0030 | LangGraph Platform Docker Deployment | APIP-5006, APIP-0020 | Ready to Work |
| APIP-0040 | Model Router v1 with Rate Limiting and Token Budgets | APIP-0010 | Created |
| APIP-5000 | Test Infrastructure Setup for LangGraph Graph Unit Testing | APIP-0010, APIP-0020 | backlog |
| APIP-5001 | Test Database Setup and Migration Testing | APIP-0010 | Ready to Work |
| APIP-5003 | LangGraph Platform Security Hardening and Network Boundary Documentation | APIP-0030 | In Elaboration |
| APIP-5004 | Secrets Engine and API Key Management | APIP-0040 | Ready to Work |
| APIP-5006 | LangGraph Server Infrastructure Baseline | none | In Elaboration |
| APIP-5007 | Database Schema Versioning and Migration Strategy | APIP-0010 | Ready |
...
| ID | Title | Dependencies | Status |
|---|---|---|---|
| APIP-1010 | Structurer Node in Elaboration Graph | APIP-0020 | Created |
| APIP-1020 | Diff Planner Node in Implementation Graph | APIP-1010 | backlog |
| APIP-1030 | Implementation Graph with Atomic Change Loop | APIP-1020, APIP-0040 | backlog |
| APIP-1040 | Documentation Graph (Post-Merge) | APIP-1030 | backlog |
| APIP-1050 | Review Graph with Parallel Fan-Out Workers | APIP-1030 | backlog |
| APIP-1060 | QA Graph with Autonomous Verdict | APIP-1050 | backlog |
| APIP-1070 | Merge Graph with Learnings Extraction | APIP-1060 | backlog |
| APIP-5002 | E2E Test Plan and Playwright Framework Setup | APIP-0010, APIP-0020, APIP-1010, APIP-1020, APIP-1030, APIP-1050, APIP-1060, APIP-1070 | backlog |
| APIP-5005 | Minimal Operator Visibility CLI | APIP-0010, APIP-0020, APIP-1070 | backlog |
...
| ID | Title | Dependencies | Status |
|---|---|---|---|
| APIP-2010 | Blocked Queue and Notification System | APIP-0020 | backlog |
| APIP-2020 | Monitor UI v1 (Read-Only Dashboard) | APIP-2010 | backlog |
| APIP-2030 | Graceful Shutdown, Health Check, and Deployment Hardening | APIP-0030 | backlog |
...
| ID | Title | Dependencies | Status |
|---|---|---|---|
| APIP-3010 | Change Telemetry Table and Instrumentation | APIP-1030 | backlog |
| APIP-3020 | Model Affinity Profiles Table and Pattern Miner Cron | APIP-3010 | backlog |
| APIP-3030 | Learning-Aware Diff Planner | APIP-3020, APIP-1020 | backlog |
| APIP-3040 | Learning-Aware Model Router | APIP-3020, APIP-0040 | backlog |
...
| ID | Title | Dependencies | Status |
|---|---|---|---|
| APIP-4010 | Codebase Health Gate | APIP-1070, APIP-3090 | backlog |
| APIP-4020 | Cohesion Scanner | APIP-4010 | backlog |
| APIP-4030 | Dependency Auditor | APIP-2010 | backlog |
| APIP-4040 | Test Quality Monitor | APIP-3090 | backlog |
| APIP-4050 | Dead Code Reaper | APIP-3090 | backlog |
| APIP-4060 | KB Freshness Check and Stale Entry Archival | APIP-3090 | backlog |
| APIP-4070 | Weekly Pipeline Health Report | APIP-4010, APIP-3020, APIP-2010 | backlog |
...
2. APIP-0020 — Supervisor Graph (Minimal Loop)
3. APIP-1010 — Structurer Node in Elaboration Graph
4. APIP-1020 — Diff Planner Node in Implementation Graph
