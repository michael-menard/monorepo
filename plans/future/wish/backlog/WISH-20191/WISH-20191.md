---
doc_type: story
title: "WISH-20191: Schema Drift Detection Tool - MVP (db:check command)"
story_id: WISH-20191
story_prefix: WISH
status: backlog
phase: 1
created_at: "2026-01-31T10:15:00-07:00"
updated_at: "2026-01-31T10:15:00-07:00"
...
- **Split Reason:** Scope expansion during QA elaboration (8 new features added via user decisions). Original story grew from 20 ACs to 28+ ACs, exceeding recommended complexity.
- **This Part:** 1 of 3 (MVP core drift detection)
- **Dependency:** Depends on WISH-2057 (Schema Evolution Policy and Versioning Strategy)
- **Related Stories:**
...
This MVP story focuses on the core drift detection capabilities without advanced features like automated remediation or CI/CD integration (covered in follow-up stories WISH-20192 and WISH-20193).
...
- Automatic schema drift remediation (covered in WISH-20192)
...
- Blocking deployments on drift detection (covered in WISH-20193)
- Cross-database schema comparison (focus on single database vs expected state)
- `.driftignore` file support (covered in WISH-20192)
- Historical drift tracking (covered in WISH-20192)
- Verbose debugging mode (covered in WISH-20192)
...
- **Mitigation**: Document in release notes that `.driftignore` support is coming in WISH-20192

### Non-MVP Risks

**Risk 4: Performance on Large Schemas**
- Introspection on databases with 100+ tables may be slow
- **Mitigation**: Document performance characteristics; `--table` flag can be added in future
...
|---|---|---|---|
| 2026-01-31 10:15 | pm-story-split-leader | Created split story 1/3 from WISH-20190 (MVP core drift detection) | WISH-20191.md |
