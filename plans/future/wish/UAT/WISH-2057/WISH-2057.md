...
- [x] Schema drift detection tool (`db:check` command from WISH-2007 Enhancement #3) → WISH-20191 (MVP), WISH-20192 (Advanced Features), WISH-20193 (CI/CD Integration) - split from original WISH-20190
- [ ] Automated rollback script generation based on migration metadata (deferred)
