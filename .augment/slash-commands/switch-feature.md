...
Agent: ⚠️  You have uncommitted changes. What would you like to do?
       1. Commit changes
       2. Stash changes
       3. Discard changes (dangerous!)
       4. Cancel
...
Agent: Please provide a stash message (optional):

User: WIP on main app

Agent: [Executing]
       git stash push -m "WIP on main app"
       ...
       3. /Users/user/Monorepo/tree/bug/main-app-456
...
Agent: ✅ To switch to feature/gallery-123:
       ...
       Your changes have been stashed safely.
...
- **Start Feature**: `.augment/slash-commands/start-feature.md`
