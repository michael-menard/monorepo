...
import { z } from 'zod'
import {
  type PermissionFeature as Feature,
  type QuotaType,
  type Tier,
...
/**
 * Auth state selector schema
 * Consumers must provide Redux state with this structure
 */
...
type RootState = z.infer<typeof RootStateSchema>
...
export function usePermissions() {
  ...
  const {
    ...
    error,
    refetch,
  } = permissionsApi.useGetPermissionsQuery(undefined, {
