/**
 * @repo/upload - Finalize Client Service
 *
 * Story REPA-002: Consolidate finalize client into @repo/upload
 *
...
/**
 * Options for finalize call (serializable parts)
 */
...
/**
 * Full options including non-serializable parts
 */
