...
describe('FormErrorBoundary', () => {
  it('renders form-specific error fallback', () => {
    ...
    expect(
      screen.getByText('There was an error processing your form. Please try again.'),
    ).toBeInTheDocument()
  })
...
describe('DataErrorBoundary', () => {
  it('renders data-specific error fallback', () => {
    ...
    expect(
      screen.getByText('Unable to load or process data. Please try again.'),
    ).toBeInTheDocument()
  })
...
describe('ComponentErrorBoundary', () => {
  it('renders component-specific error fallback', () => {
    ...
    expect(
      screen.getByText('There was an error in the TestComponent component.'),
    ).toBeInTheDocument()
  })
