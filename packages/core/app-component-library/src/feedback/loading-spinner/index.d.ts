...
declare const LoadingSpinner: React.ForwardRefExoticComponent<
  LoadingSpinnerProps & React.RefAttributes<HTMLDivElement>
>
declare const pulseVariants: (
  props?:
    | ({
        variant?: 'default' | 'destructive' | 'secondary' | 'muted' | null | undefined
        size?: 'sm' | 'lg' | 'xl' | 'default' | null | undefined
...
declare const PulseSpinner: React.ForwardRefExoticComponent<
  PulseSpinnerProps & React.RefAttributes<HTMLDivElement>
>
declare const dotsVariants: (
  props?:
    | ({
        variant?: 'default' | 'destructive' | 'secondary' | 'muted' | null | undefined
        size?: 'sm' | 'lg' | 'xl' | 'default' | null | undefined
...
declare const DotsSpinner: React.ForwardRefExoticComponent<
  DotsSpinnerProps & React.RefAttributes<HTMLDivElement>
>
