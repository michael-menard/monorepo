...
describe('Auth API', () => {
  ...
  describe('Login Mutation', () => {
    it('should make login request with correct parameters', async () => {
      ...
      const result = await store.dispatch(authApi.endpoints.login.initiate(loginData))
  ...
  describe('Signup Mutation', () => {
    it('should make signup request with correct parameters', async () => {
      ...
      const result = await store.dispatch(authApi.endpoints.signup.initiate(signupData))
