 ...
 */
export declare function getRTKQueryCacheConfig(type: keyof typeof RTK_QUERY_CACHE_CONFIGS): RTKQueryCacheConfig;
/**
 * Create custom RTK Query cache configuration
 */
export declare function createRTKQueryCacheConfig(config: Partial<RTKQueryCacheConfig>): RTKQueryCacheConfig;
/**
 * Optimistic update helper for RTK Query mutations
 */
export declare function createOptimisticUpdate<T, R>(updateQueryData: (queryName: string, arg: T, updateFn: (draft: R) => void) => any, queryName: string, arg: T, updateFn: (draft: R) => void): any;
/**
 ...
 */
export declare function createCacheUpdate<T>(data: T, id?: string | number): {
    type: "update";
    data: T;
 ...
 */
export declare function createCachedBaseQuery(baseUrl: string, options?: {
    cacheControl?: string;
    etag?: boolean;
    maxAge?: number;
}): {
 ...
 */
export declare function createCacheErrorHandler(error: any, retryCount?: number, maxRetries?: number): {
    retry: boolean;
    retryCount: number;
} | {
    retry: boolean;
