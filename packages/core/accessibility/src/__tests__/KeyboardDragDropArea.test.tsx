...
describe('KeyboardDragDropArea', () => {
  ...
  it('should render instructions when dragging', () => {
    ...
    render(<KeyboardDragDropArea {...defaultProps} state={draggingState} showInstructions={true} />)
  ...
  it('should render controls when dragging and showControls is true', () => {
    ...
    render(<KeyboardDragDropArea {...defaultProps} state={draggingState} showControls={true} />)
  ...
  it('should not render controls when showControls is false', () => {
    ...
    render(<KeyboardDragDropArea {...defaultProps} state={draggingState} showControls={false} />)
  ...
  it('should apply correct CSS classes when dragging', () => {
    ...
    const { container } = render(<KeyboardDragDropArea {...defaultProps} state={draggingState} />)
  ...
  it('should apply correct CSS classes when moving', () => {
    ...
    const { container } = render(<KeyboardDragDropArea {...defaultProps} state={movingState} />)
