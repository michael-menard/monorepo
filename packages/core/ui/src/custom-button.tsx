...
const customButtonVariants = cva(
  buttonVariants(),
  {
    variants: {
      style: {
        gradient: 'bg-gradient-to-r from-primary to-secondary text-white shadow-lg hover:shadow-xl transition-all duration-300',
        glass: 'bg-background/20 backdrop-blur-sm border border-gray-200/50 text-foreground hover:bg-background/30',
...
export interface CustomButtonProps
  extends VariantProps<typeof customButtonVariants> {
  className?: string;
  [key: string]: any;
}
