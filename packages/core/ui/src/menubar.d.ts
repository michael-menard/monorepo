...
declare function MenubarRadioItem({
  ...
  children,
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.RadioItem>): import('react/jsx-runtime').JSX.Element
...
declare function MenubarSeparator({
  className,
  ...props
}: React.ComponentProps<typeof MenubarPrimitive.Separator>): import('react/jsx-runtime').JSX.Element
