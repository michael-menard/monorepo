        ...
        <div className="mb-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul className="text-blue-800 space-y-1">
              <li>• <strong>Delete:</strong> Remove multiple images at once</li>
              <li>• <strong>Add to Album:</strong> Create a new album with selected images</li>
              <li>• <strong>Download:</strong> Download all selected images</li>
              <li>• <strong>Share:</strong> Share multiple images via native share or clipboard</li>
            </ul>
          </div>
        </div>
