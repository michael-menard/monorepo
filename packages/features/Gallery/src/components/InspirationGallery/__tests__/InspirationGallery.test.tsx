...
describe('InspirationGallery', () => {
  ...
  describe('Image Loading', () => {
    ...
    it('displays empty state when no images', () => {
      ...
      expect(screen.getByText('Start adding images to your inspiration gallery!')).toBeInTheDocument();
    });
  });
  ...
  describe('Infinite Scroll', () => {
    ...
    it('shows end message when no more images', () => {
      ...
      expect(screen.getByText("You've reached the end of your inspiration gallery!")).toBeInTheDocument();
    });
  });
