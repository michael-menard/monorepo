...
import MocInstructionCard from '../components/MocInstructionCard';
import type { MocInstruction } from '../schemas';

const mockInstruction: MocInstruction = {
  id: '1',
...
describe('MOC Package', () => {
  it('exports MocInstructionCard component', () => {
    expect(MocInstructionCard).toBeDefined();
  });

  it('renders MocInstructionCard with correct data', () => {
    render(
      <MocInstructionCard
