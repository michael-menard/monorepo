...
vi.mock('../../../store/wishlistApi', async () => {
  ...
  return {
    ...actual,
    useCreateWishlistItemMutation: () => [mockCreateMutation, { isLoading: false, error: null }],
    useUpdateWishlistItemMutation: () => [mockUpdateMutation, { isLoading: false, error: null }],
  }
})
