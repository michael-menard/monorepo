        ...
        <div className="mb-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul className="text-blue-800 space-y-1">
              <li>• <strong>Delete:</strong> Remove multiple items at once</li>
              <li>• <strong>Mark Purchased:</strong> Mark selected items as purchased</li>
              <li>• <strong>Mark Not Purchased:</strong> Mark selected items as not purchased</li>
              <li>• <strong>Update Priority:</strong> Change priority for multiple items</li>
              <li>• <strong>Update Category:</strong> Change category for multiple items</li>
            </ul>
          </div>
        </div>
