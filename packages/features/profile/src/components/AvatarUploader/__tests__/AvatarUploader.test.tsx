...
describe('AvatarUploader', () => {
  ...
  it('renders avatar with image when current avatar is provided', () => {
    render(
      <AvatarUploader currentAvatar="https://example.com/avatar.jpg" onUpload={mockOnUpload} />,
    )
  ...
  it('validates file type and shows error for invalid types', async () => {
    render(
      <AvatarUploader onUpload={mockOnUpload} acceptedFileTypes={['image/jpeg', 'image/png']} />,
    )
