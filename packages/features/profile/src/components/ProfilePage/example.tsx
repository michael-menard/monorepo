...
export const ProfilePageExample: React.FC = () => {
  ...
  const sidebarContent = (
    <ProfileSidebar profile={exampleProfile} onEdit={handleEditProfile} isEditable={true} />
  )
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6">
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200">
          ...
          <p className="text-gray-600">
            This section would contain forms for changing password, email, and other account
            settings.
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200">
          ...
          <p className="text-gray-600">
            This section would contain forms for managing notification preferences and theme
            settings.
          </p>
        </div>
      </div>
  ...
  return (
    <ProfilePage profile={exampleProfile} sidebarContent={sidebarContent}>
      {mainContent}
    </ProfilePage>
  )
}
