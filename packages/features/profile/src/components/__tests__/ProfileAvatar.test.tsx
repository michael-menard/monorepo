...
describe('ProfileAvatar', () => {
  ...
  describe('Basic Rendering', () => {
    it('should render avatar with image when avatarUrl is provided', () => {
      render(<ProfileAvatar {...defaultProps} avatarUrl="https://example.com/avatar.jpg" />)
  ...
  describe('Editable Avatar with Upload', () => {
    ...
    it('should handle file selection and call onAvatarUpload', async () => {
      render(
        <ProfileAvatar {...defaultProps} editable={true} onAvatarUpload={mockOnAvatarUpload} />,
      )
  ...
  describe('Status and Verification Indicators', () => {
    it('should show online status when enabled', () => {
      render(<ProfileAvatar {...defaultProps} showStatus={true} isOnline={true} />)
    ...
    it('should show offline status when enabled', () => {
      render(<ProfileAvatar {...defaultProps} showStatus={true} isOnline={false} />)
    ...
    it('should show verification badge when verified', () => {
      render(<ProfileAvatar {...defaultProps} showVerified={true} isVerified={true} />)
    ...
    it('should not show verification badge when not verified', () => {
      render(<ProfileAvatar {...defaultProps} showVerified={true} isVerified={false} />)
  ...
  describe('Non-editable Avatar with Edit Button', () => {
    ...
    it('should show edit button when editable but no upload handler', () => {
      render(<ProfileAvatar {...defaultProps} editable={true} onEdit={mockOnEdit} />)
  ...
  describe('Custom Styling', () => {
    it('should apply custom className', () => {
      render(<ProfileAvatar {...defaultProps} className="custom-avatar-class" />)
