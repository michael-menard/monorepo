...
describe('MocInstructionsGallery', () => {
  ...
  it('shows empty state when no instructions', () => {
    ...
    expect(
      screen.getByText('Create your first MOC instruction to get started!'),
    ).toBeInTheDocument()
  })
  ...
  it('handles search functionality', async () => {
    ...
    render(
      <MocInstructionsGallery instructions={mockInstructions} onFiltersChange={onFiltersChange} />,
    )
    ...
    await waitFor(() => {
      expect(onFiltersChange).toHaveBeenCalledWith(expect.objectContaining({ search: 'vehicle' }))
    })
  })
  ...
  it('handles sort change', async () => {
    ...
    render(<MocInstructionsGallery instructions={mockInstructions} onSortChange={onSortChange} />)
  ...
  it('shows edit and delete buttons when editable', () => {
    render(<MocInstructionsGallery instructions={mockInstructions} isEditable={true} />)
  ...
  it('does not show edit and delete buttons when not editable', () => {
    render(<MocInstructionsGallery instructions={mockInstructions} isEditable={false} />)
  ...
  it('shows loading state for load more', () => {
    render(<MocInstructionsGallery instructions={mockInstructions} hasMore={true} loading={true} />)
  ...
  it('filters instructions based on search term', () => {
    ...
    expect(screen.getByText('Test Instruction 1')).toBeInTheDocument()
    expect(
      screen.queryByText('Test Instruction 2') === null ||
        screen.queryByText('Test Instruction 2') === undefined,
    ).toBe(true)
  })
