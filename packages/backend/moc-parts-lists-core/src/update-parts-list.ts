 ...
 * Update Parts List
 *
 * Platform-agnostic core logic for updating parts list metadata.
...
import {
  ...
  type PartsList,
  type PartsListRow,
  type UpdatePartsListInput,
  type MocInstructionRow,
} from './__types__/index.js'

/**
 * Minimal database interface for update-parts-list operations
 */
export interface UpdatePartsListDbClient {
 ...
 */
export interface UpdatePartsListSchema {
  mocPartsLists: {
    id: unknown
    mocId: unknown
    title: unknown
...
/**
 * Update Parts List Result
 */
export type UpdatePartsListResult =
 ...
 *
 * Updates title, description, notes, costEstimate, and/or actualCost.
 *
...
export async function updatePartsList(
  db: UpdatePartsListDbClient,
  schema: UpdatePartsListSchema,
  userId: string,
  mocId: string,
  partsListId: string,
  input: UpdatePartsListInput,
): Promise<UpdatePartsListResult> {
