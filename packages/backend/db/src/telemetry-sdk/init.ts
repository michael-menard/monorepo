 ...
 */
let sdkInstance: TelemetrySdk | null = null
let sdkConfig: TelemetrySdkConfig | null = null
let bufferState: BufferState | null = null
let flushTimer: FlushTimerHandle = null
 ...
 */
export function initTelemetrySdk(
  ...
  sdkInstance = {
    withStepTracking: async <T>(
      ...
      const result = await withStepTrackingImpl(
        stepName,
        operation,
        options ?? {},
        sdkConfig,
 ...
 */
export function getSdkInstance(): TelemetrySdk | null {
  return sdkInstance
}
