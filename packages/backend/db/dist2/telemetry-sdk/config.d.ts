 ...
 */
import { type TelemetrySdkConfig } from './__types__/index.js';
/**
 * Default SDK Configuration
 * Used when partial config is provided to initTelemetrySdk()
 */
export declare const DEFAULT_SDK_CONFIG: Partial<TelemetrySdkConfig>;
/**
 ...
 */
export declare function validateConfig(config: Partial<TelemetrySdkConfig> & Pick<TelemetrySdkConfig, 'source'>): TelemetrySdkConfig;
