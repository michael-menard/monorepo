...
function extractCorrelationId() {
    try {
        ...
        const { getCurrentSpan } = require('@repo/observability');
 ...
 */
export async function withStepTracking(stepName, operation, options = {}, config, bufferStateRef) {
 ...
 */
export async function withStateTracking(itemId, fromState, toState, options = {}, config) {
    const correlationId = extractCorrelationId();
