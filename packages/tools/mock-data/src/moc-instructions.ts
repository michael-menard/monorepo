...
export const mockMocInstructions: MockInstruction[] = [
  ...
  },
  {
    ...
    rating: 4.7,
    downloadCount: 723,
    createdAt: new Date('2024-01-04T09:00:00Z').toISOString(),
    updatedAt: new Date('2024-01-12T13:45:00Z').toISOString(),
  },
  {
    id: '5',
    ...
    updatedAt: new Date('2024-01-14T10:30:00Z').toISOString(),
  },
  {
    id: '6',
    ...
    steps: [
      {
        ...
        updatedAt: new Date('2024-01-06T10:00:00Z').toISOString(),
      },
    ],
    partsList: [
    ...
    rating: 4.8,
    downloadCount: 892,
    createdAt: new Date('2024-01-06T09:00:00Z').toISOString(),
    ...
    steps: [
      {
        ...
        estimatedTime: 30,
        difficulty: 'hard',
        createdAt: new Date('2024-01-07T10:00:00Z').toISOString(),
    ...
    steps: [
      {
        ...
        updatedAt: new Date('2024-01-08T10:00:00Z').toISOString(),
      },
    ],
    partsList: [
