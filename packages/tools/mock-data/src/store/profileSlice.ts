...
export const selectRecentActivities = (state: { profile: ProfileState }) => state.profile.recentActivities;
...
export const selectActivityFilters = (state: { profile: ProfileState }) => state.profile.activityFilters;
