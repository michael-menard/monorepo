...
export function createMulterDestination(
  ...
  return (req: any, file: Express.Multer.File, cb: (error: Error | null, destination: string) => void) => {
    try {
...
export function createMulterFilename(
  ...
  return (req: any, file: Express.Multer.File, cb: (error: Error | null, filename: string) => void) => {
    try {
...
export function createLegoInstructionMulterConfig(uploadDir: string, getUserId: (req: any) => string) {
  const multer = require('multer');
...
export function createLegoPartsListMulterConfig(uploadDir: string, getUserId: (req: any) => string) {
  const multer = require('multer');
