...
import { fileFixtures, configFixtures } from './fixtures.js'
...
describe('validation integration tests', () => {
  ...
  describe('complex validation scenarios', () => {
    ...
    it('should validate file count limits correctly', () => {
      const manyFiles = Array.from(
        { length: 6 },
        (_, i) => new File([`content-${i}`], `file-${i}.jpg`, { type: 'image/jpeg' }),
      )
  ...
  describe('real-world scenarios', () => {
    it('should handle typical image upload scenario', () => {
      const imageFiles = [fileFixtures.jpegImage, fileFixtures.pngImage, fileFixtures.webpImage]
    ...
    it('should handle mixed media upload scenario', () => {
      const mixedFiles = [fileFixtures.jpegImage, fileFixtures.mp4Video, fileFixtures.pdfDocument]
