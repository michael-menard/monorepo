...
import { uploadSingleFile, uploadFiles, retryUpload } from '../upload-utils.js'
import { fileFixtures, configFixtures, serverResponseFixtures } from '../../__tests__/fixtures.js'
import {
  mockXMLHttpRequest,
...
describe('upload-utils', () => {
  ...
  describe('uploadSingleFile', () => {
    ...
    it('should validate required endpoint', async () => {
      ...
      await expect(uploadSingleFile(fileFixtures.jpegImage, config)).rejects.toThrow(
