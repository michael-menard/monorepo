          ...
          <div className="entry-recommendations">
            ...
            {entry.ring === 'Adopt' && (
              <div className="recommendation adopt">
                <strong>Adopt:</strong> This technology is recommended for new projects. 
                The team has high confidence in its ability to serve our purpose.
              </div>
            )}
            {entry.ring === 'Trial' && (
              <div className="recommendation trial">
                <strong>Trial:</strong> This technology is worth pursuing with the goal 
                of understanding how it will affect your architecture.
              </div>
            )}
            {entry.ring === 'Assess' && (
              <div className="recommendation assess">
                <strong>Assess:</strong> This technology is promising and has clear 
                potential value-add for us. Worth investigating further.
              </div>
            )}
            {entry.ring === 'Hold' && (
              <div className="recommendation hold">
                <strong>Hold:</strong> This technology is not recommended to be used 
          ...
          {entry.moved && (
            <div className="entry-movement-details">
              ...
              <div className="movement-explanation">
                {entry.moved === 'in' && (
                  <p>This technology has moved closer to the center, indicating increased confidence and adoption.</p>
                )}
                {entry.moved === 'out' && (
                  <p>This technology has moved further from the center, indicating decreased confidence or being phased out.</p>
                )}
              </div>
            </div>
          )}
