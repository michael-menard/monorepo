...
describe('WishlistItemCard', () => {
  it('renders all item details', () => {
    render(<WishlistItemCard item={mockItem} />);
  ...
  it('calls onEdit when edit button is clicked', () => {
    const onEdit = vi.fn();
    render(<WishlistItemCard item={mockItem} onEdit={onEdit} />);
  ...
  it('calls onDelete when delete button is clicked', () => {
    ...
    render(<WishlistItemCard item={mockItem} onDelete={onDelete} />);
  ...
  it('calls onDragStart and onDragEnd when dragged', () => {
    ...
    render(
      <WishlistItemCard item={mockItem} onDragStart={onDragStart} onDragEnd={onDragEnd} />
    );
  ...
  it('renders with minimal required fields', () => {
    ...
    render(<WishlistItemCard item={item as any} />);
