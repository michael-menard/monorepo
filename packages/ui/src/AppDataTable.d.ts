...
export declare function AppDataTable<T>({ data, columns, onRowClick, emptyMessage, className, rowClassName, pagination, sortable, defaultSort, onSortChange, }: AppDataTableProps<T>): import("react/jsx-runtime").JSX.Element;
