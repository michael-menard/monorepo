...
export declare const SANITIZATION_PROFILES: {
    ...
    readonly RICH_TEXT: {
        ...
        readonly customConfig: {
            readonly ALLOWED_TAGS: readonly ["b", "i", "em", "strong", "u", "br", "p", "div", "span", "h1", "h2", "h3", "h4", "h5", "h6", "ul", "ol", "li", "a", "blockquote", "code", "pre"];
 ...
 */
export declare function sanitizeInput(input: string | null | undefined, config?: SanitizationConfig): string;
/**
 * Sanitize input based on input type
 */
export declare function sanitizeByInputType(input: string | null | undefined, inputType?: string): string;
/**
 * Sanitize form data object
 */
export declare function sanitizeFormData<T extends Record<string, any>>(formData: T, fieldConfigs?: Partial<Record<keyof T, SanitizationConfig>>): T;
/**
 * Create a sanitization hook for React components
 */
export declare function createSanitizationHook(config?: SanitizationConfig): (value: string | null | undefined) => string;
/**
 * Validate that input is safe after sanitization
 */
export declare function validateSanitizedInput(original: string, sanitized: string, options?: {
    strict?: boolean;
}): {
    isValid: boolean;
    warnings: string[];
 ...
 */
export declare function safeSanitizeInput(input: string | null | undefined, config?: SanitizationConfig): string;
