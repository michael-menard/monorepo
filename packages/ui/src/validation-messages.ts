...
export const validationMessages = {
  ...
  exactLength: (fieldName: string, length: number) => `${fieldName} must be exactly ${length} characters`,
  ...
  number: {
    ...
    decimal: (fieldName: string, decimals: number) => `${fieldName} can have up to ${decimals} decimal places`,
  },
  date: {
...
export const createEnhancedSchemas = {
  ...
  terms: () =>
    z
      .boolean()
      .refine((val) => val === true, validationMessages.terms),
} as const;
