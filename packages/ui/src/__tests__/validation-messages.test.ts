...
describe('validationMessages', () => {
  ...
  describe('password messages', () => {
    it('provides password min length message', () => {
      expect(validationMessages.password.minLength(8)).toBe('Password must be at least 8 characters');
    });
    ...
    it('provides password strength messages', () => {
      expect(validationMessages.password.weak).toBe('Password is too weak. Please choose a stronger password');
      expect(validationMessages.password.medium).toBe('Password strength is medium. Consider adding more complexity');
  ...
  describe('number messages', () => {
    ...
    it('provides decimal message', () => {
      expect(validationMessages.number.decimal('Amount', 2)).toBe('Amount can have up to 2 decimal places');
    });
  });
  ...
  describe('file messages', () => {
    ...
    it('provides file type message', () => {
      expect(validationMessages.file.type(['jpg', 'png'])).toBe('File type must be one of: jpg, png');
    });
  ...
  describe('network messages', () => {
    it('provides network error message', () => {
      expect(validationMessages.network).toBe('Network error. Please check your connection and try again');
    });
    ...
    it('provides forbidden message', () => {
      expect(validationMessages.forbidden).toBe('Access denied. You do not have permission for this action');
    });
