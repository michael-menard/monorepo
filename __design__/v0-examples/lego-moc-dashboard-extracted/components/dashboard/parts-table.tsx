        ...
        <Table>
          <TableHeader>
            <TableRow className="border-border hover:bg-transparent">
              <TableHead className="text-muted-foreground text-xs md:text-sm whitespace-nowrap">
                MOC Name
              </TableHead>
              <TableHead className="text-muted-foreground text-xs md:text-sm hidden sm:table-cell">
                Theme
              </TableHead>
              ...
              <TableHead className="text-muted-foreground text-right text-xs md:text-sm hidden md:table-cell">
                Last Updated
              </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {sortedData.map(moc => (
              <TableRow key={moc.id} className="border-border hover:bg-muted/50">
                ...
                <TableCell className="text-muted-foreground text-xs md:text-sm hidden sm:table-cell py-2 md:py-4">
                  {moc.theme}
                </TableCell>
                <TableCell className="py-2 md:py-4">
                  <div className="flex items-center gap-1.5 md:gap-2">
                    ...
                    <span className="text-xs md:text-sm font-medium text-card-foreground whitespace-nowrap">
                      {moc.coverage}%
                    </span>
                  </div>
                </TableCell>
