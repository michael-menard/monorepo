...
export function QuickActions() {
  return (
    <div className="flex flex-wrap gap-2 md:gap-3">
      ...
      <Button
        variant="outline"
        className="gap-1.5 md:gap-2 text-xs md:text-sm h-8 md:h-10 px-3 md:px-4 border-border bg-transparent text-foreground hover:bg-accent hover:text-accent-foreground"
      >
