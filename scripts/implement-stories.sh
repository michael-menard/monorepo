...
# find_story_dir, get_story_stage, is_elaborated — sourced from scripts/lib/story-utils.sh
...
# validate_artifact_schema, validate_phase_gate — sourced from scripts/lib/story-utils.sh
