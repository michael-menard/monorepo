...
- `ac-verdict` KB artifact absent after completion → Log warning: `"QA Advisory: ac-verdict artifact not found — continuing to Phase 2"`. Proceed to Phase 2.
- `EVIDENCE-JUDGE COMPLETE` or `EVIDENCE-JUDGE COMPLETE WITH WARNINGS` → Read `ac-verdict` artifact via `kb_read_artifact({ story_id: "{STORY_ID}", artifact_type: "analysis", artifact_name: "ac-verdict" })`.
...
| -------------- | ------------------------- | ----- | ------------------------ | ---------------------------------------------------------------- |
| evidence-judge | `evidence-judge.agent.md` | haiku | `ac-verdict` KB artifact | `EVIDENCE-JUDGE COMPLETE` / `COMPLETE WITH WARNINGS` / `BLOCKED` |
...
| `ac-verdict` KB artifact absent                                | Log warning, proceed to Phase 2                    |
