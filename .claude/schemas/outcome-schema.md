...
sources:
  ...
  decisions: string        # Path to ELAB.yaml (elaboration lifecycle artifact)
```
...
4. Reads `ELAB.yaml` `summary` fields for decision metrics (gaps_resolved, opportunities_logged)
