...
version: 1.0.0
name: telemetry-log
description: Log an agent invocation record for a specific phase of story workflow. Called by workflow agents after completing a phase. Writes to the wint.agent_invocations table via workflow_log_invocation MCP tool.
kb_tools:
...
// → Row inserted in wint.agent_invocations
